...
public class CitiesCountry {
    public static void main(String[] args) {
        ...
        // Define the desired country
        String targetCountry = "France";

        // Define SQL query to retrieve data for the specific country from the city table
        ...
        query(url, username, password, query, orderBy, "City Name", "City Population", targetCountry);
    }
    ...
    public static void query(String url, String username, String password, String query, String orderBy, String... columns) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                // Set the value of the country parameter in the prepared statement
                statement.setString(1, columns[2]); // Assuming the country name is passed as the third argument
