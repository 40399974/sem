...
public class TopNoContinents {
    ...
    public static void main(String[] args) {
        ...
        String query = "SELECT name, population, continent FROM country WHERE continent = ?";
        ...
        query(url, username, password, query, orderBy, topItems, "Name", "Population", "Continent", targetContinent);
    }
    ...
    public static void query(String url, String username, String password, String query, String orderBy, int topItems, String... columns) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                ...
                statement.setString(1, columns[3]); // Assuming the continent is passed as the fourth argument
