...
import java.sql.*;
public class CountriesSpecificContinent {
    public static void main(String[] args) {
        ...
        // Define SQL query to retrieve data for the specific continent
        ...
        query(url, username, password, query, orderBy, "Name", "Population", targetContinent);
    }
