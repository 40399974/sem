...
public class TopNoCities {
    public static void main(String[] args) {
        ...
        String query = "SELECT name, population, district, CountryCode FROM city";
        ...
        query(url, username, password, query, orderBy, topItems, "Name", "District", "Population", "CountryCode");
    }
