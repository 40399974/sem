...
CREATE TABLE `countrylanguage` (
  ...
  KEY `CountryCode` (`CountryCode`),
  CONSTRAINT `counpackage com.napier.sem;
...
public class SelectSpecific {
    public static void main(String[] args) {
        ...
        String continent = "Europe"; // Specify the continent here
        String country = "United Kingdom"; // Specify country
        String region = "Scotland"; // Specify region
        String city = "Glasgow"; // Specify city

        // Define SQL query to retrieve data for countries based on specified criteria
        String query = "SELECT country.name AS Country, city.name AS City, city.district AS Region " +
                "FROM country " +
...
tryLanguage_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
